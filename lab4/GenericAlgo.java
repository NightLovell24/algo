...
public class GenericAlgo {
	 private final int populationSize; // размер попул€ции
	    private final double mutationRate; // шанс мутации
	    private final double crossoverRate; // смешивание двух попул€ций
	    private final int elitismCount; //
		protected int tournamentSize; 

		public GenericAlgo(int populationSize, double mutationRate, double crossoverRate, int elitismCount,
				int tournamentSize) {
